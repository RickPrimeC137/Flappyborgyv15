...
class GameScene extends Phaser.Scene {
  ...
  const extraTop    = 160; // combien la hitbox dépasse vers le BAS pour le tuyau du haut
  const extraBottom = 20; // combien elle dépasse vers le HAUT pour le tuyau du bas
